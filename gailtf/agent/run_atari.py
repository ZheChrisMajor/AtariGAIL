...
def train(args):
    ...
    if args.task == 'play_agent':
        ...
        playAtari(env, agent, U, modelPath=args.load_model_path, fps=50000, stochastic=args.stochastic_policy, zoom=2, delay=10)
        env.close()
        sys.exit()
    ...
    if args.task == 'train_gail':
        ...
        # discriminator - DO A BREAK POINT, DUMBY HERE
        if len(env.observation_space.shape) > 2:
            ...
            if args.wasserstein:
                ...
                # This is the one used when we run train_gail
